...
@Dao
interface SongPlayCountRoomDao {
    @Query(QUERY_SINGLE)
    fun getOneById(id: Long): Flow<SongPlayCountEntity?>

    @Query(QUERY_MOST_PLAYS)
    fun getMostPlays(): Flow<List<SongPlayCountEntity>>
    ...
    companion object {
        ...
        private const val TABLE = SongPlayCountEntity.TABLE
