...
object Title {
    fun model(
        ...
        placeholder: Int = com.vgleadsheets.ui.core.R.drawable.ic_logo,
        ...
        TitleListModel(
            title ?: resources.getString(com.vgleadsheets.ui.strings.R.string.app_name),
            if (isLoading) {
    ...
    data class Config(
        ...
        val placeholder: Int = com.vgleadsheets.ui.core.R.drawable.ic_logo,
