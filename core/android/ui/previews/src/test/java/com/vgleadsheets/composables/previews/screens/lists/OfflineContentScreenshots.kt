...
class OfflineContentScreenshots(
    ...
    @Test
    fun offlineContentListScreen() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            OfflineContentList(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }

    @Test
    fun offlineContentListScreenLoading() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            OfflineContentListLoading(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }
