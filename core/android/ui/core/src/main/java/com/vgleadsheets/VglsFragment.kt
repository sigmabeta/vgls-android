...
abstract class VglsFragment : Fragment(), MavericksView {
    ...
    protected val onAppBarButtonClick = { (activity as BackHandler).onAppBarButtonClick() }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!disablePerfTracking()) {
            ...
            (requireActivity() as Navigator).setPerfSpec(getPerfSpec().name)
        }
    ...
    protected fun getFragmentRouter() = (activity as Navigator)
}
