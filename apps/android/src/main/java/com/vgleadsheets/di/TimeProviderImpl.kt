...
/**
 * JVM/Android [TimeProvider]. Shared code deals in kotlinx-datetime / kotlin.time types; the
 * locale-aware date formatting is done here with java.time (available on minSdk 26+ and desktop JVM).
 * Replaces the old threeten-based ThreeTenImpl.
 */
