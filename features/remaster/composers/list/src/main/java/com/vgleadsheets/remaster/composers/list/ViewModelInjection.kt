...
internal interface Provider {
    fun composerListViewModelFactory(): Factory
}
...
@Composable
fun composerListViewModel(navigateTo: (String) -> Unit): ViewModelImpl {
    val activity = LocalContext.current as Activity
    val entryPoint = EntryPointAccessors.fromActivity(activity, Provider::class.java)
    val factory = entryPoint.composerListViewModelFactory()
